...
def generate_launch_description():
      return LaunchDescription([
          ...
          DeclareLaunchArgument('host',                  default_value='catnet-ip.icgc.cat'),
          ...
          DeclareLaunchArgument('username',              default_value='bylogix'),
          DeclareLaunchArgument('password',              default_value='bylogix'),
